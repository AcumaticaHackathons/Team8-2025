...
{
    [Serializable]
    [PXCacheName("VERSIONHistory")]
    public class VERSIONHistory : PXBqlTable, IBqlTable
    {
        #region VersionAuditID
        [PXDBIdentity(IsKey = true)]
        public virtual int? VersionAuditID { get; set; }
        public abstract class versionAuditID : PX.Data.BQL.BqlInt.Field<versionAuditID> { }
        #endregion
